...
public class DevDDCurrent 
{
    ...
    public DevDDCurrent(String sourcePath, String delListName, LoggerInf logger)
        throws TException
    {
    ...
    public static void main_1(String[] args) 
            throws IOException,TException 
    {
        String sourcePath = "/home/loy/MRTMaven/github/admin/mrt-store-admin/tasks/210420-current/test";
        //String delListName = "tdd.txt";
        String delListName = "dd-19.txt";
        //String delListName = "bad-2.txt";
        LoggerInf logger = new TFileLogger(NAME, 50, 50);
        DevDDCurrent dd = new DevDDCurrent(sourcePath, delListName, logger);
        dd.processList();
        dd.validateList();
    }
            ...
            throws IOException,TException 
    {
        ...
        LoggerInf logger = new TFileLogger(NAME, 50, 50);
        DevDDCurrent dd = new DevDDCurrent(basePath, delListName, logger);
        dd.validate(localID,oldMan, currentMan, buildMan);
    }
    
    public static void main_3(String[] args) 
            throws IOException,TException 
    {
        String basePath = "/home/loy/MRTMaven/github/admin/mrt-store-admin/tasks/210420-current/test";
    ...
    public static void main_validate(String[] args) 
            throws IOException,TException, Exception
    {
        String basePath = "/home/loy/MRTMaven/github/admin/mrt-store-admin/tasks/210420-current/test";
        
        String delListName = "dd-19.txt";
        File base = new File(basePath);
        LoggerInf logger = DevDDCurrent.setLogger(base);
        if (false) return;
        DevDDCurrent dd = new DevDDCurrent(basePath, delListName, logger);
        dd.validateList();
    }
            ...
            throws TException 
    {
        try {
            ...
            //String delListName = "tdd.txt";
            String delListName = "dd-3.txt";
            LoggerInf logger = DevDDCurrent.setLogger(base);
            DevDDCurrent dd = new DevDDCurrent(sourcePath, delListName, logger);
            Long [] uparr = new Long[1];
            uparr[0] = 2003L;
            dd.updateList(uparr);
    ...
    public void processList()
            throws TException 
    {
        System.out.println("**start processList:" + delList);
        try {
    ...
    public void updateList(Long [] nodes)
            throws TException 
    {
        try {
            FileInputStream fstream = new FileInputStream(delList);
    ...
    protected void update(Long [] nodes, Identifier ark, File currentManifest, File builtManifest)
            throws TException 
    {
        FixDD fixDD = null;
        try {
            ...
            throws TException 
    {
        FixDD fixDD = null;
        try {
            fixDD = new FixDD(node, ark, currentManifest, builtManifest, logger);
            fixDD.replace();
            ...
            throws TException 
    {
        ...
        try {
            ...
            VersionMap oldMap = getVersionMap(2003, oldArk);
            VersionMap currentMap = getVersionMap(2003, currentArk);
        ...
        throws TException
    {
        ...
        String base = "http://uc3-mrtsandbox2-stg:35121/storage/manifest/";
        try {
