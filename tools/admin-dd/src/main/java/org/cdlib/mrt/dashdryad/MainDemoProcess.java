 ...
 * @author replic
 */
public class MainDemoProcess 
{
    protected static final String NAME = "MainDemoProcess";
    ...
    {
        String sourcePath = "/home/loy/MRTMaven/github/admin/mrt-store-admin/tasks/210420-current/demo";
        DDCurrent dd = new DDCurrent(sourcePath);
        DDConfig config = dd.getConfig();
        dd.setProcessList("dd-2.txt");
