 ...
 * @author replic
 */
public class MainDevUpdate 
{
    protected static final String NAME = "MainDevUpdate";
    ...
    {
        String sourcePath = "/home/loy/MRTMaven/github/admin/mrt-store-admin/tasks/210420-current/dev";
        DDCurrent dd = new DDCurrent(sourcePath);
        //dd.setProcessList("dd-8.txt");
        dd.setProcessList("ddc.txt");
